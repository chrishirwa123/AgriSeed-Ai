...
<main class="container" style="padding: 1.5rem 1.25rem 3rem; max-width: 780px;">
  <h2>🦠 Plant Doctor</h2>
  <p class="card-muted">Upload a photo of a plant or leaf for an AI health check. This is an agricultural aid, not a lab diagnosis.</p>
  ...
  <form id="plantDoctorForm" class="card">
    ...
    <input type="file" id="plantImageInput" accept="image/jpeg,image/png,image/webp" capture="environment" class="visually-hidden">
    <img id="imagePreview" class="image-preview" style="display:none; margin-top:1rem;" alt="Selected plant photo preview">

    <div class="field" style="margin-top:1rem;">
      <label for="plantDescription">Optional description</label>
      <textarea id="plantDescription" rows="2" placeholder="e.g. Tomato leaves turning yellow from the bottom up, past week"></textarea>
    </div>
